    ...
    <div className="key-features-container">
        <div className='f-col'>
            <div className='f-col'>
                ...
                <div className='f20 f-dark-blue mt40'>
                  Today, several centralized exchanges are operating with no transparency. Although <br/>
                  DEX are growing in numbers, there will always be a need for fiat on-ramps. InfinityBit<br/>
